...
type PsychometricTestRegistration struct {
...
type PsychometricTestQuestion struct {
	QuestionID int      `json:"question_id" bson:"question_id"`
	Question   string   `json:"question" bson:"question"`
	Options    []string `json:"options" bson:"options"`
}

type PsychometricTestAnswer struct {
	QuestionID     int    `json:"question_id" bson:"question_id"`
	Question       string `json:"question" bson:"question"`
...
type PsychometricTestResult struct {
	ID             string                   `json:"id" bson:"_id,omitempty"`
	UserID         string                   `json:"user_id" bson:"user_id"`
	Email          string                   `json:"email" bson:"email"`
	Name           string                   `json:"name" bson:"name"`
	Age            int                      `json:"age" bson:"age"`
	StudentType    string                   `json:"student_type" bson:"student_type"`
	Answers        []PsychometricTestAnswer `json:"answers" bson:"answers"`
...
type PsychometricTestSubmitRequest struct {
...
type PsychometricTestRegistrationRequest struct {
}
