$(document).ready(function () {
    ...
    $(document).on("click", "#edit-degree", function (e) {
        ...
        window.location.href = "/masters/degreetype/" + formatId + "/edit";
    });
    ...
    $(document).on("click", "#update-format", function (e) {
        ...
        $.ajax({
            url: "/masters/degreetype/" + formatId,
            method: "POST",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
    ...
    $(document).on("click", "#delete-degree", function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                console.error("Error:", error);
                toastr.error("Failed to delete the DegreeType. Please try again.");
            },
        });
    });
