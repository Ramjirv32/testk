        ...
        if (currency_id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#value_id').empty().append('<option value="" disabled selected>Select Current Value</option>');
                    $.each(response, function(key, value) {
                        $('#value_id').append('<option value="'+value.id+'">'+value.name+'</option>');
                    });
                }
            });
        } else {
            $('#value_id').empty().append('<option value="" disabled selected>Select Currency value test</option>');
        }
    });

    $("#add-currency-ranges-btn").on("click", function (e) {

        e.preventDefault();
        let form = document.getElementById("currency_range");
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    toastr.error("Failed to create currency range post.");
                }
            },
