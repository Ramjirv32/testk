            ...
            <div className="col-lg-5 d-flex mx-auto col-sm-12">
              <div className="w-full max-w-md mx-auto d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
                <div className="w-full px-4">
                  <h2 className="text-center text-white mb-2" style={{ fontSize: '2.5rem', fontWeight: 'bold' }}>
                    Admin Login
                  </h2>
                  <p className="text-center text-white mb-5" style={{ fontSize: '0.9rem', opacity: 0.8 }}>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                      ...
                      <Link href="/" className="text-decoration-none" style={{ color: '#E084CD', fontWeight: 'bold' }}>
                        Back to Home
                      </Link>
                    </div>
                  </form>
