...
export default function CognitiveTestPage() {
    ...
    useWebSocket(wsUrl, {
        onMessage: (data) => {
            ...
            if (data.type === 'cognitive_approval' && data.user_id === user?.id) {
                console.log('Cognitive registration approved!');

                checkRegistrationStatus();
            }
        },
        onOpen: () => {
            console.log('WebSocket connected for Cognitive updates');
        }
    });
        ...
        return (
            <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#faf4ec' }}>
                <div className="text-center">
                    ...
                    <div style={{ color: '#2563eb', fontSize: '18px', fontWeight: '600' }}>Loading...</div>
                </div>
                <style jsx>{`
                    @keyframes spin {
        ...
        <div className="min-h-screen" style={{ backgroundColor: '#faf4ec', padding: '40px 20px' }}>
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div style={{ marginBottom: '32px', textAlign: 'center' }}>
                    ...
                    <h1 style={{ fontSize: '36px', fontWeight: 'bold', color: '#2563eb', marginBottom: '12px' }}>
                        Cognitive Test
                    </h1>
                    <p style={{ fontSize: '16px', color: '#6b7280' }}>
                        Test your cognitive and reasoning abilities (For students under 18)
                    </p>
                </div>
                    ...
                    <div style={{
                        ...
                        {registration.status === 'approved' && (
                            <div style={{ textAlign: 'center' }}>
                                ...
                                <p style={{ color: '#6b7280', marginBottom: '24px' }}>
                                    Your registration has been approved. You can now take the Cognitive test.
                                </p>
                                <Link
