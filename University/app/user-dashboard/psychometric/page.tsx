...
export default function PsychometricTestPage() {
    ...
    const { isConnected } = useWebSocket(wsUrl, {
        onMessage: (data) => {
            ...
            if (data.type === 'psychometric_approval' && data.user_id === user?.id) {
                console.log('Psychometric registration approved!');

                checkRegistrationStatus();
            }
        },
        onOpen: () => {
            console.log('WebSocket connected for Psychometric updates');
        },
        onError: (err) => {
            console.error('WebSocket connection error for Psychometric:', err);
        }
    });
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div style={{ marginBottom: '32px', textAlign: 'center', position: 'relative' }}>
                    ...
                    <p style={{ fontSize: '16px', color: '#6b7280' }}>
                        Assess your emotional, and cognitive traits (For students aged 15 and below)
                    </p>
                </div>
                ...
                {registration ? (
                    <div style={{
                        ...
                        {registration.status === 'approved' && (
                            <div style={{ textAlign: 'center' }}>
                                ...
                                <p style={{ color: '#6b7280', marginBottom: '24px' }}>
                                    Your registration has been approved. You can now take the Psychometric test.
                                </p>

                                <Link
                                    href="/user-dashboard/psychometric-test"
                                    style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#1f2937', marginBottom: '16px' }}>
                            Register for Psychometric Test
                        </h2>
