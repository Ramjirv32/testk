...
export default function PescioRegisterPage() {
    ...
    useTestRegistrationWebSocket({
        ...
        onRegistrationApproved: (data) => {
            console.log(' PESCIO Registration approved:', data);
            setRegistrationStatus({
                status: 'approved',
                created_at: registrationStatus?.created_at || new Date().toISOString(),
            });

            alert(' Your PESCIO test registration has been approved! You can now take the test.');
        },
        onRegistrationRejected: (data) => {
            console.log(' PESCIO Registration rejected:', data);
            setRegistrationStatus({
                status: 'rejected',
                reason: data.reason,
                created_at: registrationStatus?.created_at || new Date().toISOString(),
            ...
            alert(` Your PESCIO test registration has been rejected. Reason: ${data.reason}`);
        },
    });
            ...
            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                ...
                >
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                        ...
                        >
                            <svg style={{ width: '48px', height: '48px', color: '#06b6d4' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h1 style={{ fontSize: '28px', fontWeight: 'bold', color: '#1f2937', marginBottom: '12px', textAlign: 'center' }}>
                        PESCIO Test Registration
                    </h1>

                    <p style={{ fontSize: '16px', color: '#6b7280', marginBottom: '32px', textAlign: 'center' }}>
                        Register for the PESCIO career interest test. Your registration will be reviewed by an admin before you can proceed.
                    </p>
                        ...
                        <>
                            <div style={{
                                ...
                                <ul style={{ fontSize: '13px', color: '#1e40af', margin: '0', paddingLeft: '20px' }}>
                                    <li>36 multiple-choice questions</li>
                                    <li>Career interest assessment (P-E-S-C-I-O)</li>
                                    <li>Takes approximately 15-20 minutes</li>
                                    <li>Available for all students</li>
                                </ul>
                            </div>
                            ...
                            <button
                                ...
                                onMouseOver={(e) => {
                                    if (!submitting) e.currentTarget.style.backgroundColor = '#0891b2';
                                }}
                                onMouseOut={(e) => {
                                    if (!submitting) e.currentTarget.style.backgroundColor = '#06b6d4';
                                }}
                            >
