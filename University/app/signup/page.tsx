...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signup(formData.name, formData.email, formData.password, formData.dateOfBirth);
            ...
            <div className="col-lg-5 d-flex mx-auto col-sm-12">
              <div className="w-full max-w-md mx-auto d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
                <div className="w-full px-4">
                  <h2 className="text-center text-white mb-5" style={{ fontSize: '2.5rem', fontWeight: 'bold' }}>Sign Up</h2>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 position-relative">
                      <input
                        ...
                        disabled={isLoading}
                      />
                      <i className="fa fa-user position-absolute" style={{ right: '20px', top: '50%', transform: 'translateY(-50%)', color: '#6c757d' }}></i>
                    </div>
                    ...
                    <div className="mb-4 position-relative">
                      ...
                      />
                      <i className="fa fa-calendar position-absolute" style={{ right: '20px', top: '50%', transform: 'translateY(-50%)', color: '#6c757d' }}></i>
                    </div>
                    ...
                    <div className="mb-4 position-relative">
                      ...
                      />
                      <i
                        className={`fa ${showConfirmPassword ? 'fa-eye-slash' : 'fa-lock'} position-absolute`}
                        style={{ right: '20px', top: '50%', transform: 'translateY(-50%)', color: '#6c757d', cursor: 'pointer' }}
                    ...
                    <div className="text-center">
                      ...
                      <Link href="/login" className="text-decoration-none" style={{ color: '#E084CD', fontWeight: 'bold' }}>
                        Login Here
                      </Link>
                    </div>
                  </form>
